...
BEGIN
  FOREACH tbl IN ARRAY tables LOOP
    -- Skip quietly if a table doesn't exist in this Supabase project (some of the above
    -- are only created once their own feature's migration has been run) -- this migration
    -- should not fail just because, say, agent_dispatches' own migration hasn't landed yet.
