-- 2026-09-03: Data repair -- roles wrongly mass-reassigned to Tac-Tik
--
...
INSERT INTO audit_log (ts, what, detail, user_id, org_id) VALUES
  (to_char(now(), 'YYYY-MM-DD HH24:MI'), 'move role to organization (data repair)', 'Admin -> Bodgit&Scarpa (fixing role org_id mix-up)', '871fd585-5734-4b71-9ecd-422ec90f2ad3', '6373bb04-fc25-4a72-b43b-ccd8bb110cda'),
  (to_char(now(), 'YYYY-MM-DD HH24:MI'), 'move role to organization (data repair)', 'Admin (RLS test org) -> RLS Script Test 1786518151369 (fixing role org_id mix-up)', '871fd585-5734-4b71-9ecd-422ec90f2ad3', '6373bb04-fc25-4a72-b43b-ccd8bb110cda'),
  (to_char(now(), 'YYYY-MM-DD HH24:MI'), 'move role to organization (data repair)', 'Manager -> Bodgit&Scarpa (fixing role org_id mix-up)', '871fd585-5734-4b71-9ecd-422ec90f2ad3', '6373bb04-fc25-4a72-b43b-ccd8bb110cda'),
  (to_char(now(), 'YYYY-MM-DD HH24:MI'), 'move role to organization (data repair)', 'Planner -> Bodgit&Scarpa (fixing role org_id mix-up)', '871fd585-5734-4b71-9ecd-422ec90f2ad3', '6373bb04-fc25-4a72-b43b-ccd8bb110cda'),
  (to_char(now(), 'YYYY-MM-DD HH24:MI'), 'move role to organization (data repair)', 'Viewer -> Bodgit&Scarpa (fixing role org_id mix-up)', '871fd585-5734-4b71-9ecd-422ec90f2ad3', '6373bb04-fc25-4a72-b43b-ccd8bb110cda');
